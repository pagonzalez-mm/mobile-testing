...
async function setBluetoothState(on) {
    if (await this.adb.getApiLevel() < 30) {
        await this.checkBroadcast([
            '-a', constants_1.BLUETOOTH_SETTING_ACTION,
            '-n', constants_1.BLUETOOTH_SETTING_RECEIVER,
...
async function unpairAllBluetoothDevices() {
    await this.checkBroadcast([
        '-a', constants_1.BLUETOOTH_UNPAIR_ACTION,
        '-n', constants_1.BLUETOOTH_UNPAIR_RECEIVER,
